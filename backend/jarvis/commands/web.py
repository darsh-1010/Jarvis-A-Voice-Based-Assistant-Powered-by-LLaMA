...
@registry.register(
    name="search_google", description="Search Google for any topic or question."
)
def search_google(query: str) -> None:
    ...
    log_action(
        ...
        f"I'm opening Google to search for '{query}'.",
    )
...
@registry.register(
    name="search_youtube", description="Search YouTube for a video, song, or topic."
)
def search_youtube(query: str) -> None:
    ...
    log_action(
        ...
        f"I'm searching YouTube for '{query}'.",
    )
...
def test_internet_speed() -> str:
    ...
    log_action(
        "WEB_SPEEDTEST",
        "Initializing speedtest-cli",
        "I'm measuring your current internet speeds.",
    )
    ...
    log_action(
        "WEB_SPEEDTEST_RES",
        f"Speeds: {result}",
        "I've finished measuring your internet speed.",
    )
    return result
...
def fetch_latest_news(category: str = "general") -> list:
    ...
    log_action(
        "WEB_NEWS",
        f"Category: {category}",
        f"I'm looking up the latest {category} news.",
    )
